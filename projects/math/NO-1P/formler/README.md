...
![Formler screenshot](./screenshot.png)
...
Evaluate common formulas and rearrange them to solve for another variable. Covers Sinus 1P Kap. 7.1–7.3.
...
- **Load it straight in** — use [`formler.appstudio`](./formler.appstudio):
  **Share → Import**, or drop it into your `App Studio Projects` folder.
- **Copy-paste** — open [`formler.html`](./formler.html), copy it all, then
  **New → paste → Run App**.
