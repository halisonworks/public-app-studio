...
![Brøkregning screenshot](./screenshot.png)
...
Simplify/expand fractions, the four operations on fractions, and a fraction of a number — with steps. Covers Sinus 1P Kap. 1.3–1.5.

Interactive learning tool for Norwegian **matematikk 1P** (LK20). **Norwegian UI.**
A single self-contained HTML page (Tailwind via CDN). Category: **Math · NO-1P**.

## Load it into App Studio

- **Load it straight in** — use [`brokregning.appstudio`](./brokregning.appstudio):
  **Share → Import**, or drop it into your `App Studio Projects` folder.
- **Copy-paste** — open [`brokregning.html`](./brokregning.html), copy it all, then
  **New → paste → Run App**.
