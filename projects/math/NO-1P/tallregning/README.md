...
![Tallregning screenshot](./screenshot.png)
...
Order of operations worked step by step, and estimation (overslag). Covers Sinus 1P Kap. 1.1–1.2.
...
- **Load it straight in** — use [`tallregning.appstudio`](./tallregning.appstudio):
  **Share → Import**, or drop it into your `App Studio Projects` folder.
- **Copy-paste** — open [`tallregning.html`](./tallregning.html), copy it all, then
  **New → paste → Run App**.
